  ...
  return (
    <div className='place-content-around mt-5 ml-10 mb-5 mr-10'>
        <Link className="nav-link" to={`/order/${title}`}>
            {image ? (
            <img className="object-cover mb-3 service-img" src={`data:image/png;base64,${service.image.img}`}/>
            ) : (
                <img className="object-cover mb-3 service-img" src={`https://creative-agency-server-2tl0.onrender.com/${service.img}`} alt=""/>
            )}
